...
namespace TrackerLibrary2.Models
{
    /// <summary>
    ...
    public class PrizeModel
    {
        ...
        /// <summary>
        /// The fixed amount this place earns or zer if it is not used.
        /// </summary>
        public decimal PrizeAmount { get; set; }
        /// <summary>
        /// The number that represets the percentage of the overall take or
